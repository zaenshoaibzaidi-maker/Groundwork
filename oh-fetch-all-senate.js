...
async function main() {
  // Load election data
  const electionData = JSON.parse(readFileSync(join(__dirname, 'oh-senate-elections.json'), 'utf8'));
  ...
  writeFileSync(
    join(__dirname, 'oh-senate-data.json'),
    JSON.stringify(results, null, 2)
  );
  console.log('\nDone! Saved to oh-senate-data.json');
}
