...
//
// Usage:  node oh-fetch-elections.js <district_number>
// Example: node oh-fetch-elections.js 3
//
...
if (!districtArg) {
  console.error("Usage: node oh-fetch-elections.js <district_number>");
  console.error("Example: node oh-fetch-elections.js 3");
  process.exit(1);
}
