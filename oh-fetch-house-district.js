#!/usr/bin/env node
// oh-fetch-house-district.js
// Pulls ACS 5-year demographic data for any Ohio State House district.
//
// Usage:  node oh-fetch-house-district.js <district_number>
// Example: node oh-fetch-house-district.js 8
//
...
if (!districtArg) {
  console.error("Usage: node oh-fetch-house-district.js <district_number>");
  console.error("Example: node oh-fetch-house-district.js 8");
  process.exit(1);
}
